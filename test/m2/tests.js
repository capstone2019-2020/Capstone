...
exports.netlists = [
   ...
   */
  {
    filepath: '../test/m2/netlist1_independent.txt',
    data: [
      { id: 'V1', type: 'V', pnode: 1, nnode: 0, value: 12 },
      { id: 'R1', type: 'R', pnode: 1, nnode: 2, value: 3000 },
      { id: 'C1', type: 'C', pnode: 2, nnode: 0, value: 0.000000001 },
   ...
   */
  {
    filepath: '../test/m2/netlist2_all.txt',
    data: [
      { id: 'V1', type: 'V', pnode: 1, nnode: 0, value: 12  },
   ...
   */
  {
    filepath: '../test/m2/netlist3_invalid1.txt',
    data: []
  },
  /**
   ...
   */
  {
    filepath: '../test/m2/netlist4_invalid2.txt',
    data: []
  }
];
