...
const generateCircuit = (canvas_id) => {
	...
	let nodes = [{"id":"V_n1","x":656,"y":181},{"id":"ISC_n1","x":716,"y":181},{"id":"V_n2","x":191,"y":196},{"id":"ISC_n2","x":251,"y":196},{"id":"V_n3","x":516,"y":293},{"id":"ISC_n3","x":576,"y":293},{"id":"V_n4","x":578,"y":270},{"id":"ISC_n4","x":638,"y":270},{"id":"V_n5","x":222,"y":308},{"id":"ISC_n5","x":282,"y":308},{"id":"V_n6","x":194,"y":276},{"id":"ISC_n6","x":254,"y":276},{"id":"V_n7","x":402,"y":353},{"id":"ISC_n7","x":462,"y":353},{"id":"V_n8","x":530,"y":388},{"id":"ISC_n8","x":590,"y":388}];
	...
	nodes.forEach(n => {
		circuit_canvas.appendChild(Element.createNode({x:n.x, y:n.y}));
	});
};
