...
const algebra = require('../../src/rwalgebrajs/RWalgebra.js');
...
describe('computeSFG()', function() {
  const {computeSFG} = require('../../src/sfgjs/m1');
...
describe('computeMasons()', function() {
  const {computeMasons} = require('../../src/sfgjs/m1');
...
describe('integration', function() {
  const {computeSFG, computeMasons} = require('../../src/sfgjs/m1');
  const MAX_SINGLE_EXEC = 300;
  const MAX_TOTAL_EXEC_EASY = 5000;
  const MAX_TOTAL_EXEC_MED = 6000;
  const MAX_TOTAL_EXEC_HARD = 7000;
